...
use windows::Win32::System::Variant::{self as WinVariant, VARENUM, VT_BSTR};
...
pub fn safe_array_to_vec(arr: &SAFEARRAY, item_type: VARENUM) -> WMIResult<Vec<Variant>> {
    ...
    match item_type {
        WinVariant::VT_I1 => copy_type_to_vec(arr, Variant::I1),
        WinVariant::VT_I2 => copy_type_to_vec(arr, Variant::I2),
        WinVariant::VT_I4 => copy_type_to_vec(arr, Variant::I4),
        WinVariant::VT_I8 => copy_type_to_vec(arr, Variant::I8),
        WinVariant::VT_UI1 => copy_type_to_vec(arr, Variant::UI1),
        WinVariant::VT_UI2 => copy_type_to_vec(arr, Variant::UI2),
        WinVariant::VT_UI4 => copy_type_to_vec(arr, Variant::UI4),
        WinVariant::VT_UI8 => copy_type_to_vec(arr, Variant::UI8),
        WinVariant::VT_R4 => copy_type_to_vec(arr, Variant::R4),
        WinVariant::VT_R8 => copy_type_to_vec(arr, Variant::R8),
        WinVariant::VT_BSTR => {
            let mut items = vec![];
